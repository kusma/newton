...
void task_reduce() {
	...
	// do the palette generation (subtract 1 color for the forced black)7
	list<Node*> leaves = generate(out_count-1);

//	int lcount = leaves.size();
//	fwrite(&lcount, 2, 1, stdout);

	// output first color: black
	{
		int zero=0;
