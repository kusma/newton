...
int ptc_open(char *title,int width,int height)
{
...

    {
        ...
        AppendMenu(menu, MF_STRING, SC_ZOOM_1x1, _T("Zoom 1 x 1"));
        AppendMenu(menu, MF_STRING, SC_ZOOM_2x2, _T("Zoom 2 x 2"));
        AppendMenu(menu, MF_STRING, SC_ZOOM_4x4, _T("Zoom 4 x 4"));
    }
